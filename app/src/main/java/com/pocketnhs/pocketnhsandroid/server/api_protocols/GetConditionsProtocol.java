...
public class GetConditionsProtocol implements PocketNHSServerProtocol {
    ...
    public String getEndpointURL(Map<String, Object> params) {
        ...
        String endpoint =  URL_ENDPOINT + params.get(INDEX_LETTER);
    ...
    public static synchronized PocketNHSServerProtocol getInstance() {
        if (mInstance == null) {
            mInstance = new GetConditionsProtocol();
        }
        return mInstance;
    }
