...
public class GetGenderConditionsListProtocol implements PocketNHSServerProtocol {

    private static final String URL_ENDPOINT =  ServerSettings.SERVER_BASE_URL +  "/chq/articles";

    private static final String PROTOCOL_ID =  "Gender conditions list";

    public static final String LIST_LINK = "list link";
    ...
    public String getEndpointURL(Map<String, Object> params) {
        ...
        String endpoint = removeKey(  (String)params.get(LIST_LINK));
    ...
    public static synchronized PocketNHSServerProtocol getInstance() {
        if (mInstance == null) {
            mInstance = new GetGenderConditionsListProtocol();
        }
        return mInstance;
    }
