...
public class ShowGenderConditionItemDetails extends AppCompatActivity implements DataReadyListener {
    ...
    private void setupToolbar() {
        ...
        ivInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Bundle bundle = ActivityOptionsCompat.makeSceneTransitionAnimation(ShowGenderConditionItemDetails.this)
                        .toBundle();
                Intent intent = new Intent(ShowGenderConditionItemDetails.this,InfoActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.condition_detail_menu, menu);
        return true;
    }
    ...
    private void favoriteCondition() {
        if (mCondition != null) {
            boolean success = LibraryDataManager.getInstance().toggleConditionSavedToFavorites(mCondition,false);
            if (success){
