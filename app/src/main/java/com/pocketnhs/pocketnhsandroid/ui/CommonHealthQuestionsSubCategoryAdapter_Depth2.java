...
public class CommonHealthQuestionsSubCategoryAdapter_Depth2 extends RecyclerView.Adapter<CommonHealthQuestionsSubCategoryAdapter_Depth2.MyViewHolder> {
        ...
        public MyViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    NHSTextLinkPair pair = list.get(pos);
                    ApplicationState.lastQuestionsUrl = pair.getLink();
    ...
    public CommonHealthQuestionsSubCategoryAdapter_Depth2(List<NHSTextLinkPair> list, Context context, WeakReference<Activity> activity) {
