...
public class NHSCHQArticle {
    ...
    public Map getPropertiesHashMap() {
        ...
        Field[] fields =  NHSCHQArticle.class.getDeclaredFields();
    ...
    public static NHSCHQArticle getCondition(Map properties){

        NHSCHQArticle condition = new NHSCHQArticle();
        Field[] fields =  NHSCHQArticle.class.getDeclaredFields();
