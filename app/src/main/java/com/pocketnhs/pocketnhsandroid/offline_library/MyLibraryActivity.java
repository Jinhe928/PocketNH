...
import com.pocketnhs.pocketnhsandroid.ui.MyLibConditionsAdapter;
...
public class MyLibraryActivity extends AppCompatActivity {
    ...
    MyLibConditionsAdapter mAdapter;
    List<NHSCondition> mConditions;
    ...
    private void setupToolbar() {
        ...
        ivInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(MyLibraryActivity.this,InfoActivity.class);
    ...
    private void setupRecyclerView() {
        ...
        */
        setupConditionsList();
        mAdapter = new MyLibConditionsAdapter(mConditions, getApplicationContext(), this);
    ...
    private void setupConditionsList() {
        ...
        mConditions =  LibraryDataManager.getInstance().getSavedConditions();
